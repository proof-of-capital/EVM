...
contract ProofOfCapitalInsufficientSupportBalanceInTokenSaleTest is BaseTest {
    using stdStorage for StdStorage;
    StdStorage private _stdstore;

    address public user = address(0x5);

    function testInsufficientSupportBalanceInTokenSale() public {
        // This test verifies that _handleTokenSale reverts with InsufficientSupportBalance
